"""inputWriter.py is responsible for generating the input data
for SPMF, a data mining library. The data that is generated by
main.py and csd.py (test_seg.csv) is imported and STS will be
build.

A Common Segment Temporal Sequence (STS)) refers to a Route R
that is described by a sequence of common segments:
R = S_1, S_2, ..., S_n.
